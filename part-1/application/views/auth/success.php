...
<head>
  ...
  <title>SimpleScheduler | Register Success</title>
...
<body class="hold-transition login-page">
  <div class="register-box">
    ...
    <div class="register-box-body">
      <p class="login-box-msg">You are registered!</p>
      <p>Thank You <?php echo $full_name; ?>! You are now ready to login.</p>
      <p>You may use the email: <?php echo $email; ?> to login in with.</p>
      <a href="<?php echo base_url().'login'; ?>" class="text-center">Ready to Login?</a>
    </div>
    <!-- /.form-box -->
  </div>
  <!-- /.register-box -->
